...
def controller(hidden_file, train_comp_name, train_wh_name, test_name):
...
if __name__ == "__main__":
    ...
    train_comp_name = sys.argv[2]
    train_wh_name = sys.argv[3]
    test = sys.argv[4]
    ...
    if train_wh_name not in ["when", "where", "how", "why"]:
        raise Exception("Choose either \"when\", \"where\", \"how\", and \"why\" as the wh-adjunct")
    ...
    controller(hidden_file, train_comp_name, train_wh_name, test_name=test)